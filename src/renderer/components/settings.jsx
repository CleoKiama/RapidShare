...
export default function Settings() {
	...
	useEffect(() => {
		if (!saveDirectory) {
			window.electron.invoke("getSaveDirectory").then((dir) => {
	...
	return (
		<div className="mx-auto mt-20 justify-evenly px-2  flex flex-row items-center">
			...
			<button
				className="rounded-xl px-2 py-1 bg-blue-700 text-sm text-white hover:bg-blue-500 cursor-pointer"
