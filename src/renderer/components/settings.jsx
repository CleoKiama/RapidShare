...
export default function Settings() {
  ...
  return (
    <div className='mx-auto mt-20 justify-evenly px-2  flex flex-row items-center'>
      <p className='text-wrap'>received files are saved in : <span onClick={() => openInExploer()} className='cursor-pointer decoration-solid text-blue-400'>{saveDirectory}</span></p>
